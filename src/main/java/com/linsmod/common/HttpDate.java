...
public final class HttpDate {
     ...
     */
    private static final ThreadLocal<DateFormat> STANDARD_DATE_FORMAT_UTC
    ...
    private static final ThreadLocal<DateFormat> STANDARD_DATE_FORMAT_GMT
            = new ThreadLocal<DateFormat>() {
        @Override
        protected DateFormat initialValue() {
            DateFormat rfc1123 = new SimpleDateFormat("EEE, dd MMM yyyy HH:mm:ss zzz", Locale.US);
    ...
    public static Date parse(String value) {
        if (value == null)
            return null;
        try {
            return STANDARD_DATE_FORMAT_GMT.get().parse(value);
    ...
    public static String format(Date value) {
        return STANDARD_DATE_FORMAT_GMT.get().format(value);
    }
}
